...
public class Ticket2Ride {
    ...
    public static void main(String[] args) {
        ...
        List<Path> adjList[] = p[0].getAdjacentcyList();

        System.out.println("Nashville is adjacent?: "+p[0].isAdjacent("Nashville", "Pittsburgh"));
        p[0].addClaimedRoute("Hayward", "Paradise");
        p[0].addClaimedRoute("Areyou", "Working");
        
        for(int i=0; i<adjList.length; i++){
           System.out.println("Adjacent List: "+adjList[i]);
            //System.out.println("Adjacent List: ");
            //System.out.println("Player0 ClaimedRoutes "+p[0].claimedRoutes[i]);
        }            
        
        System.out.println("player pieces: "+p[0].getPeicesLeft());
        int iter = 0;
        int turn = 0;
        /*
        ...
        do {
            ...
            while (player < 4) {
                ...
                System.out.println("player number: "+(player - 1)+" has "+p[(player -1)].getPeicesLeft());
